...
function menproducts()
  ...
  function todaysoffers()
	 ...
	 function insertcommnet($product)
        ...
        {
           $sql= "INSERT INTO orders(username,code,pname,cost,quantity,customersts,adminsts,sendshipping,shippingsts,tracknumber, ppic) VALUES ('$productcode[username]','$productcode[code]','$productcode[pname]','$productcode[cost]','$productcode[quantity]','$productcode[customersts]','$productcode[adminsts]','$productcode[sendshipping]','$productcode[shippingsts]', NULL,'$productcode[ppic]')";
