				...
				<table border="0">
					<tr align="center">
						<td width="230" height="100">
							<a href="loggedin.php"><img src="../res/common/eshop.png" alt="Eshop" width="200" ></a>
						</td>
						<td width="630"></td>
						<td>
        ...
        <table align="left" width="100%">
            ...
            <tr>
                <td width="50%" align="center">
                    <h3>
                        Code :
                        <input type="text" name="code" placeholder="Enter Product Code Here....">
                    </h3>
                </td>
                <td width="50%" align="center">
                    <h3>
                        Discount :
                        <input type="text" name="discount" placeholder="Enter Product Discount Here....">
                    </h3>
                </td>
            </tr>
            <tr height="30">
