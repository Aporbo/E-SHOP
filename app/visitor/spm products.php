...
<?php
$pnamee = $_GET['pname'];
$productnames = getProductByNameMale($pnamee);
?>
...
<head>
    ...
    <title>Male Person Details</title>
        ...
        <div class="content">
            ...
            <table align="left" width="100%" height="100%">
                <?php foreach ($productnames as $productn) { ?>
                    <tr>
                        <td>
                            <a href="man_product.php?id=<?= $productn['code'] ?>"><img src="pictures\<?= $productn['pdpic']; ?>" align="left" align="top" width="20%" height="100"><br><h4><?= $productn['name']; ?> <br><?= $productn['sprice']; ?></h4></a> <br><br><br><br><br><br>
                        </td>
                    </tr>
                <?php } ?>
            </table>
