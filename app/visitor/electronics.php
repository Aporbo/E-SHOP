...
<head>
	<title>Electronics ditels</title>
	...
	<table align="center" width="1600" >
		...
		<label><b>Catagories</b></label><br><hr>
			...
			<td valign="top" width="40%" >
					...
					<table align="center" width="100%" >
						<tr  >
                            <th  align="center"><label><h3>Electronics</h3></label></th>
					...
					<tr>
						<td>
							<a href="eck products.php?pname=<?=$product['subcatagory'] ?>">
							<img src="<?php if($product['subcatagory'] =="Mobile") :?>pictures\mobile.PNG<?php endif; ?><?php if($product['subcatagory'] =="TableFan") :?>pictures\tablefan.PNG<?php endif; ?><?php if($product['subcatagory'] =="HeadPhone") :?>pictures\headphone.PNG<?php endif; ?><?php if($product['subcatagory'] =="Smart Watch") :?>pictures\watch.jpg<?php endif; ?>" align="left" align="top" width="20%" height="50%" >
