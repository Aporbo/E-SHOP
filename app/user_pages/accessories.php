	...
	<label><b class="left-category">Catagories</b></label><br><hr>
		...
		<li><a href="eck products.php?pname=Smart Watch">Smart Watches</a></li><br>
			...
			<td valign="top" width="40%" >
					...
					<tr>
						<td>
							<a href="ack products.php?pname=<?=$product['subcatagory'] ?>">
							<img src="<?php if($product['subcatagory'] =="Wallet") :?>pictures\walate.PNG<?php endif; ?><?php if($product['subcatagory'] =="BackCover") :?>pictures\backcover.PNG<?php endif; ?><?php if($product['subcatagory'] =="Bag") :?>pictures\bag.jpg<?php endif; ?><?php if($product['subcatagory'] =="HandBand") :?>pictures\handband.PNG<?php endif; ?>" align="left" align="top" width="20%" height="50%" >
