...
<link rel="stylesheet" href="css/home.css">
	<title>person ditels female</title>
</head>
		...
		<li><a href="eck products.php?pname=Smart Watch">Smart Watches</a></li><br>
			...
			<td valign="top" width="40%" >
					 ...
					 <table align="center" width="100%" >
						<br>
						<tr  >
                            <th  align="center"><label><h3>Women PRODUCTS</h3></label></th>
					...
					<tr>
						<td>
							...
							<img src="<?php if($product['subcatagory'] =="Dress") :?>pictures\pic.jpg<?php endif; ?><?php if($product['subcatagory'] =="Pant") :?>pictures\wpant.jpg<?php endif; ?><?php if($product['subcatagory'] =="Shoe") :?>pictures\leather.jpg<?php endif; ?><?php if($product['subcatagory'] =="Bags") :?>pictures\bag.jpg<?php endif; ?>" align="left" align="top" width="20%" height="50%" >
